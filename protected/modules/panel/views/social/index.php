...
Yii::app()->clientScript->registerCss('admin-crud-social-links', "
.admin-crud-page {
width: 100%;
}
/* ==========================================================
...
Yii::app()->clientScript->registerScript(
	'crud-index-social-links',
	"
$('#social-links-filter-toggle').on('click', function(e) {
e.preventDefault();
var button = $(this);
var panel = $('#social-links-filter-panel');
...
var crud_d29bb4ebc3DeleteUrl = null;
function opencrud_d29bb4ebc3DeleteModal(url) {
crud_d29bb4ebc3DeleteUrl = url;
$('#social-links-delete-modal')
.addClass('is-visible')
.attr('aria-hidden', 'false');
$('body').css('overflow', 'hidden');
}
function closecrud_d29bb4ebc3DeleteModal() {
crud_d29bb4ebc3DeleteUrl = null;
$('#social-links-delete-modal')
...
$(document).on(
'click',
'#social-links-grid .admin-crud-action--delete',
function(e) {
e.preventDefault();
...
opencrud_d29bb4ebc3DeleteModal(url);
return false;
}
);
$('#social-links-delete-cancel').on(
'click',
function(e) {
e.preventDefault();
closecrud_d29bb4ebc3DeleteModal();
return false;
}
);
$('#social-links-delete-confirm').on(
'click',
function(e) {
e.preventDefault();
var url = crud_d29bb4ebc3DeleteUrl;
if (!url) {
closecrud_d29bb4ebc3DeleteModal();
return false;
}
	...
	<div class="admin-crud-header">
		<div class="admin-crud-heading">
			...
			<p class="admin-crud-description">
				Gestiona y administra social links.
			</p>
		</div>
		<div class="admin-crud-actions">
			<a
				id="social-links-filter-toggle"
			...
			<a
				...
				title="Nuevo social links"
				aria-label="Nuevo social links">
				<i class="fas fa-plus" aria-hidden="true"></i>
				<span>
					Nuevo social links </span>
			</a>
		</div>
	</div>
	<div
		id="social-links-filter-panel"
		...
		<form
			...
			<div class="admin-crud-filter__fields">
				...
				<div class="admin-crud-filter__field">
					<label
						class="admin-crud-filter__label"
						for="social-links-filter-name_size">
						Name Size </label>
					<?php
					echo CHtml::activeTextField(
						$model,
						'name_size',
						array(
							'id' => 'social-links-filter-name_size',
							'class' => 'admin-crud-filter__input',
							'autocomplete' => 'off',
						)
					);
				...
				<div class="admin-crud-filter__field">
					<label
						class="admin-crud-filter__label"
						for="social-links-filter-sort_order">
						Sort Order </label>
					<?php
					echo CHtml::activeTextField(
						$model,
						'sort_order',
						array(
							'id' => 'social-links-filter-sort_order',
							'class' => 'admin-crud-filter__input',
							'autocomplete' => 'off',
						)
					);
				...
				'columns' => array(
					...
					array(
						...
						'value' => function ($data) {
							...
							return '<i class="' . CHtml::encode($data->icon) . '"></i>';
						}
					),
					'url',
					'sort_order',
...
<div
	id="social-links-delete-modal"
	class="admin-crud-modal"
	aria-hidden="true"
	role="dialog"
	aria-modal="true"
	aria-labelledby="social-links-delete-modal-title">
	<div class="admin-crud-modal__dialog">
		<div class="admin-crud-modal__header">
			...
			<div>
				<h3
					id="social-links-delete-modal-title"
		...
		<div class="admin-crud-modal__footer">
			...
			<button
				type="button"
				id="social-links-delete-confirm"
