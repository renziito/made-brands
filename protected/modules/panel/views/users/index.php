...
Yii::app()->clientScript->registerCss('admin-crud-users', "
.admin-crud-page {
width: 100%;
}
/* ==========================================================
...
Yii::app()->clientScript->registerScript(
	'crud-index-users',
	"
$('#users-filter-toggle').on('click', function(e) {
e.preventDefault();
var button = $(this);
var panel = $('#users-filter-panel');
...
var crud_9bc65c2abeDeleteUrl = null;
function opencrud_9bc65c2abeDeleteModal(url) {
crud_9bc65c2abeDeleteUrl = url;
$('#users-delete-modal')
.addClass('is-visible')
.attr('aria-hidden', 'false');
$('body').css('overflow', 'hidden');
}
function closecrud_9bc65c2abeDeleteModal() {
crud_9bc65c2abeDeleteUrl = null;
$('#users-delete-modal')
...
$(document).on(
'click',
'#users-grid .admin-crud-action--delete',
function(e) {
e.preventDefault();
...
opencrud_9bc65c2abeDeleteModal(url);
return false;
}
);
$('#users-delete-cancel').on(
'click',
function(e) {
e.preventDefault();
closecrud_9bc65c2abeDeleteModal();
return false;
}
);
$('#users-delete-confirm').on(
'click',
function(e) {
e.preventDefault();
var url = crud_9bc65c2abeDeleteUrl;
if (!url) {
closecrud_9bc65c2abeDeleteModal();
return false;
}
