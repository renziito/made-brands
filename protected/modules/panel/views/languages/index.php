...
Yii::app()->clientScript->registerCss('admin-crud-languages', "
.admin-crud-page {
width: 100%;
}
/* ==========================================================
...
Yii::app()->clientScript->registerScript(
	'crud-index-languages',
	"
$('#languages-filter-toggle').on('click', function(e) {
e.preventDefault();
var button = $(this);
var panel = $('#languages-filter-panel');
...
var crud_f3e334d428DeleteUrl = null;
function opencrud_f3e334d428DeleteModal(url) {
crud_f3e334d428DeleteUrl = url;
$('#languages-delete-modal')
.addClass('is-visible')
.attr('aria-hidden', 'false');
$('body').css('overflow', 'hidden');
}
function closecrud_f3e334d428DeleteModal() {
crud_f3e334d428DeleteUrl = null;
$('#languages-delete-modal')
...
$(document).on(
'click',
'#languages-grid .admin-crud-action--delete',
function(e) {
e.preventDefault();
...
opencrud_f3e334d428DeleteModal(url);
return false;
}
);
$('#languages-delete-cancel').on(
'click',
function(e) {
e.preventDefault();
closecrud_f3e334d428DeleteModal();
return false;
}
);
$('#languages-delete-confirm').on(
'click',
function(e) {
e.preventDefault();
var url = crud_f3e334d428DeleteUrl;
if (!url) {
closecrud_f3e334d428DeleteModal();
return false;
}
	...
	<div class="admin-crud-header">
		<div class="admin-crud-heading">
			...
			<p class="admin-crud-description">
				Gestiona y administra languages.
			</p>
		</div>
		<div class="admin-crud-actions">
			<a
				id="languages-filter-toggle"
		...
		<form
			...
			<div class="admin-crud-filter__fields">
				...
				<div class="admin-crud-filter__field">
					<label
						class="admin-crud-filter__label"
						for="languages-filter-native_name">
						Native Name </label>
					<?php
					echo CHtml::activeTextField(
						$model,
						'native_name',
						array(
							'id' => 'languages-filter-native_name',
							'class' => 'admin-crud-filter__input',
							'autocomplete' => 'off',
						)
					);
				...
				<div class="admin-crud-filter__field">
					<label
						class="admin-crud-filter__label"
						for="languages-filter-is_active">
						Is Active </label>
					<?php
					echo CHtml::activeTextField(
						$model,
...
<div
	id="languages-delete-modal"
	class="admin-crud-modal"
	aria-hidden="true"
	role="dialog"
	aria-modal="true"
	aria-labelledby="languages-delete-modal-title">
	<div class="admin-crud-modal__dialog">
		<div class="admin-crud-modal__header">
			...
			<div>
				<h3
					id="languages-delete-modal-title"
