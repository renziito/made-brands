...
?>
<?php
Yii::app()->clientScript->registerCss('admin-form-users', '
/* ==========================================================
   PAGE
   ========================================================== */
.admin-form-page {
		...
		<div class="admin-form-card__body">
			...
			<div class="admin-form-fields">
				<div class="admin-form-field">
					...
					<?= $form->textField($model, 'username', ['class' => 'form-control', 'size' => 60, 'maxlength' => 100]); ?>
				</div>
				<div class="admin-form-field">
					<?= $form->labelEx($model, 'email'); ?>
					<?= $form->textField($model, 'email', ['class' => 'form-control', 'size' => 60, 'maxlength' => 255]); ?>
				</div>
				<div class="admin-form-field">
					<?= $form->labelEx($model, 'password_hash', [
						'label' => $model->isNewRecord ? 'Crear Contraseña' : 'Cambiar contraseña',
					]); ?>
					<div class="password-field">
						<?= $form->passwordField($model, 'password_hash', [
							'class' => 'form-control',
							'size' => 60,
							'maxlength' => 255,
							'value' => '',
						...
						<button type="button" class="password-toggle" aria-label="Mostrar contraseña" title="Mostrar contraseña">
							<i class="fa fa-eye"></i>
						</button>
					</div>
					<?= $form->error($model, 'password_hash'); ?>
				</div>
			</div>
		</div>
