...
/*
 * Variables expected from CategoriesController:
 *
 * CREATE:
 * $translation
 * $defaultLanguage
...
$subcategories = isset($subcategories)
	? $subcategories
	: array();

$subcategoryTranslations = isset($subcategoryTranslations)
	? $subcategoryTranslations
	: array();
...
/*
 * Index subcategory translations by subcategory.
 */
...
foreach ($subcategoryTranslations as $subcategoryTranslation) {
	...
	$subcategoryId =
		(string) $subcategoryTranslation->subcategory_id;

	if (!isset(
		$subcategoryTranslationsBySubcategory[$subcategoryId]
	)) {

		$subcategoryTranslationsBySubcategory[$subcategoryId] = array();
	}
...
/*
 * Index subcategory translations by:
 *
 * subcategory_id -> language_id
 *
 * This makes the AJAX interface easier to render.
 */
...
foreach ($subcategoryTranslations as $subcategoryTranslation) {
	...
	$languageId =
		(string) $subcategoryTranslation->language_id;

	if (!isset(
		$subcategoryTranslationsByLanguage[$subcategoryId]
	)) {

		$subcategoryTranslationsByLanguage[$subcategoryId] = array();
	}

	$subcategoryTranslationsByLanguage[$subcategoryId][$languageId] =
		$subcategoryTranslation;
}
...
.admin-form-translation:first-child {
	padding-top: 0;
}

.admin-form-translation:last-child {
	padding-bottom: 0;
	border-bottom: 0;
}
...
.admin-form-translation__status-text {
	color: #6b7280;
	font-size: 11px;
	font-weight: 600;
}
...
.admin-form-translation--inactive {
	opacity: .65;
}
...
.admin-form-subcategories {
	display: flex;
	flex-direction: column;
}

.admin-form-subcategory {
	padding: 16px 0;
	border-bottom: 1px solid #f0f1f3;
}

.admin-form-subcategory:first-child {
	padding-top: 0;
}

.admin-form-subcategory:last-child {
	padding-bottom: 0;
	border-bottom: 0;
}

.admin-form-subcategory__top {
	display: grid;
...
.admin-form-subcategory__meta {
	margin-top: 3px;
	color: #9ca3af;
	font-size: 11px;
}

.admin-form-subcategory__actions {
	display: flex;
	align-items: center;
...
.admin-form-subcategory__languages {
	display: flex;
	align-items: center;
	gap: 8px;
	min-width: 190px;
...
.admin-form-subcategory__languages-label {
	color: #6b7280;
	font-size: 9px;
	font-weight: 700;
...
.admin-form-subcategory__language-list {
	display: flex;
	align-items: center;
	justify-content: flex-end;
	flex-wrap: wrap;
...
.admin-form-subcategory__language:hover {
	border-color: #cfd4da;
	background: #f9fafb;
	color: #374151;
}

.admin-form-subcategory__language--translated {
	border-color: #d1d5db;
	background: #f3f4f6;
	color: #374151;
}

.admin-form-subcategory__language--inactive {
	opacity: .5;
}

.admin-form-subcategory__language-status {
	font-size: 9px;
}
...
.admin-form-subcategory__no-languages {
	color: #9ca3af;
	font-size: 10px;
	white-space: nowrap;
}
...
.admin-form-small-button--danger {
	border-color: #e5caca;
	background: #fff;
	color: #b42318 !important;
}

.admin-form-small-button--danger:hover {
	border-color: #d9aaaa;
	background: #fff7f7;
...
.admin-form-small-button--primary {
	background: #111827;
	border-color: #111827;
	color: #fff !important;
}

.admin-form-small-button--primary:hover {
	background: #1f2937;
	border-color: #1f2937;
	color: #fff !important;
}
...
.admin-form-modal__footer .admin-form-button {
	height: 36px;
}
...
<div class="admin-form-page">
				...
				<div>
					...
					<p class="admin-form-card__description">
						...
						echo $model->isNewRecord
							...
							: 'Actualiza la información general de esta categoría.';
		...
		<div class="admin-form-card__body">
			...
			<div class="admin-form-fields">
				...
				<div class="admin-form-field">
					...
					<span class="hint">
						...
						Determina la posición de la categoría en los listados.
			...
			<div class="admin-form-card__footer">
				...
				<div class="admin-form-actions">
					...
					<button
						type="submit"
						class="admin-form-button admin-form-button--primary pull-right">

						<?php

						if ($model->isNewRecord) {

							echo '<i class="fas fa-plus"></i> Crear categoría';
						} else {
				...
				<div class="admin-form-card__heading">
					...
					<div>
						...
						<p class="admin-form-card__description">
							...
							La categoría debe tener una traducción en el idioma predeterminado.
					...
					<div class="admin-form-field admin-form-field--full">
						...
						if ($defaultLanguage) {
							...
							echo CHtml::hiddenField(
								'CategoryTranslations[language_id]',
								$defaultLanguage->id
							);
						}
	...
	<?php else: ?>
		...
		<div
				...
				<div class="admin-form-card__heading">
					...
					<div>
						...
						<p class="admin-form-card__description">
							...
							Administra las traducciones disponibles para esta categoría.
			...
			<div class="admin-form-card__body">
				...
				<?php if ($languages): ?>
					...
					<div
						class="admin-form-translations"
						id="category-translations-list">
						...
						<?php foreach ($languages as $language): ?>
							...
							<div
								...
								data-language-id="<?= CHtml::encode($language->id); ?>">
								...
								<div class="admin-form-translation__status">
									...
									<span class="admin-form-translation__status-text">
									...
									<button
										type="button"
										class="admin-form-small-button js-category-translation-modal"
										data-category-id="<?= CHtml::encode($model->id); ?>"
										data-language-id="<?= CHtml::encode($language->id); ?>">

										<i class="fas <?= $isTranslated
															? 'fa-pen'
															: 'fa-plus'; ?>"></i>
				...
				<?php else: ?>
					...
					<div class="admin-form-empty">
						...
						<div class="admin-form-empty__icon">
						...
						<div class="admin-form-empty__title">
						...
						<div class="admin-form-empty__text">

							Configura los idiomas del sistema para poder agregar traducciones.
		...
		<div
			class="admin-form-card"
			id="category-subcategories-card">
			...
			<div class="admin-form-card__header">
				...
				<div class="admin-form-card__heading">
					...
					<div>
						...
						<p class="admin-form-card__description">
							...
							Administra las subcategorías y sus traducciones.
				...
				<button
					type="button"
					class="admin-form-add-button js-subcategory-modal"
					data-category-id="<?= CHtml::encode($model->id); ?>">
			...
			<div class="admin-form-card__body">
				...
				<?php if ($subcategories): ?>
					...
					<div
						class="admin-form-subcategories"
						id="category-subcategories-list">
						...
						<?php foreach ($subcategories as $subcategory): ?>
							...
							$currentSubcategoryTranslations =
								isset(
									$subcategoryTranslationsByLanguage[$subcategoryId]
								)
								? $subcategoryTranslationsByLanguage[$subcategoryId]
							...
							if ($defaultLanguage) {
								...
								if (
									isset(
										$currentSubcategoryTranslations[$defaultLanguageId]
									)
								) {
									...
									if (
										trim(
											(string) $defaultTranslation->name
										) !== ''
									) {
							...
							<div
								class="admin-form-subcategory"
								data-subcategory-id="<?= CHtml::encode($subcategory->id); ?>">
								...
								<div class="admin-form-subcategory__top">
									...
									<div class="admin-form-subcategory__content">
										...
										<div class="admin-form-subcategory__icon">
										...
										<div style="min-width: 0;">
											...
											<div class="admin-form-subcategory__name">
											...
											<div class="admin-form-subcategory__meta">
									...
									<div class="admin-form-subcategory__languages">
										...
										<span class="admin-form-subcategory__languages-label">
										...
										<div class="admin-form-subcategory__language-list">
											...
											<?php if ($languages): ?>
												...
												<?php foreach ($languages as $language): ?>
													...
													$hasTranslation =
														isset(
															$currentSubcategoryTranslations[$languageId]
														);
													...
													<button
														type="button"
														class="<?= $languageClasses; ?> js-subcategory-translation-modal"
														data-category-id="<?= CHtml::encode($model->id); ?>"
														data-subcategory-id="<?= CHtml::encode($subcategory->id); ?>"
														data-language-id="<?= CHtml::encode($language->id); ?>"
														title="<?= CHtml::encode($language->native_name); ?>">
														...
														<span
															class="admin-form-subcategory__language-status">
											...
											<?php else: ?>
												...
												<span class="admin-form-subcategory__no-languages">
									...
									<div class="admin-form-subcategory__actions">
										...
										<button
											type="button"
											class="admin-form-small-button admin-form-small-button--danger js-subcategory-remove"
											data-category-id="<?= CHtml::encode($model->id); ?>"
											data-subcategory-id="<?= CHtml::encode($subcategory->id); ?>"
											title="Remover subcategoría"
				...
				<?php else: ?>
					...
					<div class="admin-form-empty">
						...
						<div class="admin-form-empty__text">
							...
							Esta categoría todavía no tiene subcategorías asociadas.
...
<div
	...
	<div class="admin-form-modal__dialog">
		...
		<div
			id="admin-form-modal-body"
			class="admin-form-modal__body">

			<div class="admin-form-modal__loading">
...
$translationUrl = Yii::app()->getUrlManager()->createUrl(
	'/cpanel/categories/translation'
);

$subcategoryUrl = Yii::app()->getUrlManager()->createUrl(
	'/cpanel/categories/subcategory'
);

$subcategoryTranslationUrl = Yii::app()->getUrlManager()->createUrl(
	'/cpanel/categories/subcategoryTranslation'
);

/*
 * AJAX modal controller.
 *
 * The actual URLs/actions are intentionally kept generic here.
 * We will wire them to CategoriesController when you send
 * the current controller.
 */
Yii::app()->clientScript->registerScript(
	'categories-admin-ajax-modal',
	"
(function($) {
	...
	function openModal(title, url, data) {
		...
		$.ajax({
			...
			console.log(xhr);
				...
				modalBody.html(
					'<div class=\"admin-form-modal__error\">' +
	...
	function(e) {
		...
		if (!window.confirm(
			'¿Deseas remover esta subcategoría?'
		)) {
		...
		Yii::app()->getUrlManager()->createUrl(
			'/cpanel/categories/removeSubcategory'
		)
	) . ",
			...
			success: function(response) {
				...
				if (
					...
					var subcategory =
						$(
							'.admin-form-subcategory[data-subcategory-id=\"' +
							subcategoryId +
							'\"]'
						);
					...
					subcategory.fadeOut(
						...
						function() {
							...
							if (
								$(
									'#category-subcategories-list .admin-form-subcategory'
								).length === 0
							) {
	...
	$(document).on(
		'click',
		'.js-subcategory-translation-modal',
		function(e) {
	...
	/*
	 * AJAX forms loaded inside the modal.
	 *
	 * The controller will later return:
	 *
	 * {
	 *     success: true,
	 *     html: '...'
	 * }
	 *
	 * or a normal HTML form when validation fails.
	 */
	$(document).on(
		'submit',
