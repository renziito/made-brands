...
function opencrud_9d99837470DeleteModal(url) {
...
function closecrud_9d99837470DeleteModal() {
...
$(document).on(
'click',
'#hero-slides-grid .admin-crud-action--delete',
function(e) {
e.preventDefault();
...
opencrud_9d99837470DeleteModal(url);
return false;
}
);
$('#hero-slides-delete-cancel').on(
'click',
function(e) {
e.preventDefault();
closecrud_9d99837470DeleteModal();
return false;
}
);
$('#hero-slides-delete-confirm').on(
'click',
function(e) {
e.preventDefault();
var url = crud_9d99837470DeleteUrl;
if (!url) {
closecrud_9d99837470DeleteModal();
return false;
}
	...
	<div class="admin-crud-header">
		...
		<div class="admin-crud-actions">
			...
			<a
				...
				title="Nuevo hero slides"
				aria-label="Nuevo hero slides">
				<i class="fas fa-plus" aria-hidden="true"></i>
				<span>
					Nuevo hero slides </span>
			</a>
		</div>
	</div>
	<div
...
<div
	...
	role="dialog"
	aria-modal="true"
	aria-labelledby="hero-slides-delete-modal-title">
	<div class="admin-crud-modal__dialog">
		<div class="admin-crud-modal__header">
			...
			<div>
				<h3
					id="hero-slides-delete-modal-title"
