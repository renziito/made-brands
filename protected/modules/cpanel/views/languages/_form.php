...
?>
<?php
Yii::app()->clientScript->registerCss('admin-form-languages', '
/* ==========================================================
   PAGE
   ========================================================== */
.admin-form-page {
...
<?= $form->textField($model,'code',['class'=>'form-control','size'=>10,'maxlength'=>10]); ?>
						</div>
																				<div class="admin-form-field">
							<?= $form->labelEx($model,'locale'); ?>
<?= $form->textField($model,'locale',['class'=>'form-control','size'=>20,'maxlength'=>20]); ?>
						</div>
																				<div class="admin-form-field">
...
<?= $form->textField($model,'name',['class'=>'form-control','size'=>60,'maxlength'=>100]); ?>
																				...
																				<div class="admin-form-field">
							<?= $form->labelEx($model,'native_name'); ?>
<?= $form->textField($model,'native_name',['class'=>'form-control','size'=>60,'maxlength'=>100]); ?>
						</div>
																				<div class="admin-form-field admin-form-field--switch">
							<div>
								<?= $form->labelEx($model,'is_default'); ?>
							</div>
