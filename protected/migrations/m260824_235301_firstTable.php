...
class m260824_235301_firstTable extends CDbMigration
{
	...
	protected function createTables()
	{
		...
		$this->createTable('faq_form_submissions', array(
			...
			'estado' => 'VARCHAR(45) NULL DEFAULT "registrado"',
			'created_at' => 'DATETIME NOT NULL',
			'updated_at' => 'DATETIME NOT NULL',
			'PRIMARY KEY (`id`)',
	...
	protected function seedData()
	{
		...
		$settings = array(
			...
			array('key' => 'font_family', 'value' => 'Roboto Slab', 'type' => 'text'),
			array('key' => 'logo_font_family', 'value' => 'Josefin Sans', 'type' => 'text'),
			array('key' => 'heading_font_family', 'value' => 'Roboto Slab', 'type' => 'text'),
			array('key' => 'eyebrow_font_family', 'value' => 'Roboto Slab', 'type' => 'text'),
			array('key' => 'body_font_family', 'value' => 'Roboto Slab', 'type' => 'text'),
			array('key' => 'button_font_family', 'value' => 'Roboto Slab', 'type' => 'text'),
