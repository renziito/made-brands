 ...
 * @property AboutSectionStats[] $aboutSectionStats
 * @property AboutSectionTranslations[] $aboutSectionTranslations
 */
class AboutSections extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'aboutSectionStats' => array(self::HAS_MANY, 'AboutSectionStats', 'about_section_id'),
			'aboutSectionTranslations' => array(self::HAS_MANY, 'AboutSectionTranslations', 'about_section_id'),
		);
	}
	 ...
	 * @return AboutSections the static model class
	 */
