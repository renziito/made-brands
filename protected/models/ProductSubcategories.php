...
class ProductSubcategories extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('product_id, subcategory_id', 'required', 'message' => '{attribute} no debe estar vacio.'),
			array('product_id, subcategory_id', 'length', 'max'=>10),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('product_id, subcategory_id', 'safe', 'on'=>'search'),
		);
	}
