...
/**
 * This is the model class for table "contact_items".
 *
 * The followings are the available columns in table 'contact_items':
 * @property string $id
 ...
 */
class ContactItems extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'contactItemTranslations' => array(self::HAS_MANY, 'ContactItemTranslations', 'contact_item_id'),
		);
	}
	 ...
	 * @return ContactItems the static model class
	 */
