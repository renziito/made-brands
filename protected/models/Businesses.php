 ...
 */
class Businesses extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, image, icon, sort_order, is_active, created_at, updated_at', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'businessTranslations' => array(self::HAS_MANY, 'BusinessTranslations', 'business_id'),
		);
	}
