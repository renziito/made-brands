...
class Subcategories extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('category_id, created_at, updated_at', 'required', 'message' => '{attribute} no debe estar vacio.'),
			...
			array('id, category_id, sort_order, is_active, created_at, updated_at', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'products' => array(self::MANY_MANY, 'Products', 'product_subcategories(subcategory_id, product_id)'),
			'category' => array(self::BELONGS_TO, 'Categories', 'category_id'),
			'subcategoryTranslations' => array(self::HAS_MANY, 'SubcategoryTranslations', 'subcategory_id'),
		);
	}
